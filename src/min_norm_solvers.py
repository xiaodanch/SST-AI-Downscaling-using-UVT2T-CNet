# -----------------------------------------------------------------------------
# This file is part of the implementation for Multi-Task Learning as Multi-Objective Optimization
# License: MIT License
# Source: https://github.com/isl-org/MultiObjectiveOptimization.git
# -----------------------------------------------------------------------------
import numpy as np
import torch
        ...
        for i in range(len(vecs)):
            for j in range(i+1,len(vecs)):
                ...
                if d < dmin:
                    dmin = d
                    sol = [(i,j),c,d]
        assert sol is not None, f"cant get sol"
        return sol, dps
